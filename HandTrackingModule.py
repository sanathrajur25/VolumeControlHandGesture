...
from cv2 import VideoCapture, circle, cvtColor, flip, imshow, putText, waitKey
    ...
    def findPosition(self, img, handNo=0, draw=True):
        ...
        if self.results.multi_hand_landmarks:
            ...
            for id, lm in enumerate(myHand.landmark):
                ...
                if draw:
                    circle(img, (cx, cy), 7, (255, 0, 255), cv2.FILLED)
...
def main():
    ...
    while True:
        ...
        # putText(img, str(int(fps)), (10, 70), cv2.FONT_HERSHEY_PLAIN, 3,
        #             (255, 0, 255), 3)
